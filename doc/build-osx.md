...
Bitcoin Core is now available at `./src/layercoind`
...
You can monitor the download process by looking at the debug.log file:
    ...
    tail -f $HOME/Library/Application\ Support/Layercoin/debug.log

Other commands:
-------

    ./src/layercoind -daemon # Starts the bitcoin daemon.
    ./src/layercoin-cli --help # Outputs a list of command-line options.
    ./src/layercoin-cli help # Outputs a list of RPC commands when the daemon is running.
