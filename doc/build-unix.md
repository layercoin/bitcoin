...
This will build layercoin-qt as well, if the dependencies are met.
...
If you want to build layercoin-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a layercoin-qt executable will be
built by default.
...
Build requirements:
    ...
    sudo dnf install gcc-c++ libtool make autoconf automake openssl-devel libevent-devel boost-devel libdb6-devel libdb6-cxx-devel python3
...
Notes
-----
The release is built with GCC and then "strip layercoind" to strip the debug
