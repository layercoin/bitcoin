...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 9218 127.0.0.1:9218
	HiddenServicePort 19218 127.0.0.1:19218

The directory can be different of course, but (both) port numbers should be equal to
your bitcoind's P2P listen port (9218 by default).
...
and open port 9218 on your firewall (or use -upnp).
