...
This guide describes how to build layercoind and command-line utilities on OpenBSD.
...
in contrib/](/contrib/install_db6.sh) like so:

```shell
./contrib/install_db6.sh `pwd` CC=cc CXX=c++
```
