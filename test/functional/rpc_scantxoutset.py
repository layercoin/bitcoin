...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #send to child keys of tprv8ZgxMBicQKsPdYsGHBVd8HBNVGGdhwStYYGc5MRtxavFWjH2MY3BwpaC4Kxc1fDtDjk9dfWXMAVwGaTgNPp9ixBogS4iakyhtzywDPYM2VV
        self.nodes[0].sendtoaddress("lcrt1qqyv4eevh05ykjatyhmz9twxtqjceehc3dg6fpj", 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress("lcrt1qqxw4hpuvk6sdmp825hn5p970wwk33cl2dz72hu", 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress("lcrt1qq8n6wjn4f3samr6jm6e4mne7sxgtk6xvwpw7sd", 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress("lcrt1qqgshxc2ezy6k9k8wz2jxav373um577y58kjnn7", 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress("lcrt1qq2caaz52es88fssdqakmnjkxznr6zw54hgjr7c", 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress("lcrt1qqv3nfuv30g2f64q49m5mpmc7njdekncjh2w9wc", 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress("lcrt1qqd0k4y78x7jl9mn6q38fmy06t48q5rds03hjdr", 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress("lcrt1qqd4xdmcl40la982skhe5mjqd46fzy6cevhtlne", 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress("lcrt1qqwf26c5qsh3hl2r3efq7968u970r8j2ge3c2le", 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress("lcrt1qq05ce86jzqa80lxprasputqzra5kwf54vw7eje", 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress("lcrt1qqjhr953kdy7gywz3peewm80mv8h2ke44zuzx2n", 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress("lcrt1qqn6t3d9hdtjrq4uypkr5wnl8dwa56eq7rhzct0", 16.384) # (m/1/1/1500)
        ...
        assert_equal(self.nodes[0].scantxoutset("start", [ "pkh(" + pubk1 + ")", "wpkh(" + pubk2 + ")", "pkh(" + pubk3 + ")"])['total_amount'], Decimal("0.002"))
        assert_equal(self.nodes[0].scantxoutset("start", [ "pkh(" + pubk1 + ")", "pkh(" + pubk2 + ")", "wpkh(" + pubk3 + ")"])['total_amount'], Decimal("0.004"))
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 LYC, so each amounts uniquely identifies a subset.
