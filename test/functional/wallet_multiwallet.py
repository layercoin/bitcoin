...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w5_info['immature_balance'], 40)
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(info['immature_balance'], 40 if wallet is wallets[0] else 0)
        ...
        node.generatetoaddress(nblocks=145, address=w1.getnewaddress())
        assert_equal(w1.getbalance(), 80)
