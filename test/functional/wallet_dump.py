...
class WalletDumpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(found_addr_rsv, 30 * 2)  # 30 keys plus 100% internal keys
        ...
        assert_equal(found_addr_chg, 30 * 2)  # old reserve keys are marked as change now
        assert_equal(found_addr_rsv, 30 * 2)
