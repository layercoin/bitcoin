...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    uint256 nullNonce = uint256();
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nullNonce, nBits, nVersion, genesisReward);
}
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, VERSIONBITS_TOP_BITS, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, VERSIONBITS_TOP_BITS, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, VERSIONBITS_TOP_BITS, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
