...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    const RPCHelpMan help{"getblockstats",
                "\nCompute per block statistics for a given window. All amounts are in dragons.\n"
            ...
            "  \"avgfeerate\": xxxxx,      (numeric) Average feerate (in dragons per virtual byte)\n"
            "  \"avgtxsize\": xxxxx,       (numeric) Average transaction size\n"
            "  \"blockhash\": xxxxx,       (string) The block hash (to check for potential reorgs)\n"
            "  \"feerate_percentiles\": [  (array of numeric) Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in dragons per virtual byte)\n"
            ...
            "  \"maxfeerate\": xxxxx,      (numeric) Maximum feerate (in dragons per virtual byte)\n"
            "  \"maxtxsize\": xxxxx,       (numeric) Maximum transaction size\n"
            "  \"medianfee\": xxxxx,       (numeric) Truncated median fee in the block\n"
            "  \"mediantime\": xxxxx,      (numeric) The block median time past\n"
            "  \"mediantxsize\": xxxxx,    (numeric) Truncated median transaction size\n"
            "  \"minfee\": xxxxx,          (numeric) Minimum fee in the block\n"
            "  \"minfeerate\": xxxxx,      (numeric) Minimum feerate (in dragons per virtual byte)\n"
    ...
    for (const auto& tx : block.vtx) {
        ...
        if (loop_inputs) {
            ...
            // New feerate uses dragons per virtual byte instead of per serialized byte
    ...
    ret_all.pushKV("avgfeerate", total_weight ? (totalfee * WITNESS_SCALE_FACTOR) / total_weight : 0); // Unit: dra/vbyte
