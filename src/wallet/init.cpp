...
{
    gArgs.AddArg("-addresstype", strprintf("What type of addresses to use (\"bech32\", default: \"%s\")", FormatOutputType(DEFAULT_ADDRESS_TYPE)), false, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-changetype", "What type of change to use (\"bech32\"). Default is same as -addresstype, except when -addresstype=p2sh-segwit a native segwit output is used when sending to a native segwit address)", false, OptionsCategory::WALLET);
